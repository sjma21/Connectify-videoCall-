...
import { Badge, dividerClasses, IconButton, TextField } from '@mui/material';
...
let getUserMedia = () => {
    ...
    //        return Object.assign(stream.getVedioTracks()[0], {enabled:false})
    // } 
...
//      if((video && videoAvailable) || (audio && audioAvailable)) {
//         navigator.mediaDevices.getUserMedia({video:video, audio:audio})
//         .then(getUserMediaSuccess) // get user media success
//         .then((stream)=>{})
//         .catch((e)=>console.log(e));
//      }else{
//         try{
        ...
        {askForUsername === true ?
            ...
            <div  className={styles.meetVideoContainer}> 
               ...
               {screenAvailable === true ? <IconButton onClick = {handleScreen} style={{color: "white"}}>
                {screen===true ? <ScreenShareIcon></ScreenShareIcon> : <StopScreenShare></StopScreenShare>}
               </IconButton> : <></>}
